# Author:  Douglas A. Plager
# Date:    2030_08_08
# Assignment:   Python Project, Programming for Data Science with Python nanodegree (Udacity)
# Description:  Python-based program using NumPy and Pandas to generate various statistics 
#               for the bikeshare systems in three U.S. cities.
